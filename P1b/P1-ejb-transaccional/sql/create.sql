...
numeroVotosRestantes integer not null,
PRIMARY KEY (numeroDNI)
);

INSERT INTO censo(numeroDNI,nombre,fechaNacimiento,anioCenso,codigoAutorizacion,numeroVotosRestantes)
VALUES ('23424434Y','Jose Garcia Perez','23/11/82','2024','123', 3);
