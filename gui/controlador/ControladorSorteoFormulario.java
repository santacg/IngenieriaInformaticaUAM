...
public class ControladorSorteoFormulario {
    ...
    private ActionListener aceptarListener = new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ...
            if (fechaSorteo == null) {
                JOptionPane.showMessageDialog(vista, "Debes rellenar la fecha del sorteo o introducirla correctamente.",
                        "Error",
            ...
            if (nEntradas == null || nEntradas <= 0) {
                JOptionPane.showMessageDialog(vista,
                        "Debes rellenar el número de entradas o introducir un número de entradas correcto.", "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (tipoSorteo.equals("Sorteo por día y hora") && (vista.getDiaSorteo() == null || horaSorteo == null)) {
                JOptionPane.showMessageDialog(vista,
                        "Debes rellenar el día y la hora del sorteo o hacerlo con el formato correcto.", "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (tipoSorteo.equals("Sorteo por día y hora") && (horaSorteo.isBefore(centroExposicion.getHoraApertura())
                    || horaSorteo.isAfter(centroExposicion.getHoraCierre()))) {
                JOptionPane.showMessageDialog(vista, "La hora del sorteo debe estar entre las horas del centro.",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (tipoSorteo.equals("Sorteo por día y hora") && vista.getDiaSorteo().isBefore(fechaSorteo)) {
                JOptionPane.showMessageDialog(vista, "La fecha del día de la exposición debe ser después del día de la fecha del sorteo", "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (tipoSorteo.equals("Sorteo por fechas")
                    && (vista.getFechaInicioSorteo() == null || vista.getFechaFinSorteo() == null)) {
            ...
            if (tipoSorteo.equals("Sorteo por día y hora") && (vista.getDiaSorteo().isBefore(exposicion.getFechaInicio())
                    || vista.getDiaSorteo().isAfter(exposicion.getFechaFin()))) {
                JOptionPane.showMessageDialog(vista,
                        "La fecha de eleccion del día debe estar comprendida entre la fecha de inicio y fin de la exposición.",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }

            if (tipoSorteo.equals("Sorteo por fechas") && (vista.getFechaInicioSorteo().isBefore(exposicion.getFechaInicio())
                    || vista.getFechaFinSorteo().isAfter(exposicion.getFechaFin()))) {
                JOptionPane.showMessageDialog(vista,
                        "Las fechas de inicio y fin deben estar comprendidas entre las fecha de inicio y fin de la exposición.",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (exposicion.getEstado() == EstadoExposicion.CANCELADA) {
                JOptionPane.showMessageDialog(vista, "No se puede configurar un sorteo para una exposición cancelada.",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (fechaSorteo.isBefore(exposicion.getFechaInicio()) || fechaSorteo.isAfter(exposicion.getFechaFin())) {
                JOptionPane.showMessageDialog(vista,
                        "La fecha del sorteo debe estar comprendida entre la fecha de inicio y fin de la exposición.",
                        "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            switch (tipoSorteo) {
                case "Sorteo por día y hora":
                    ...
                    res = centroExposicion.confgiurarSorteoDiaHora(exposicion, fechaSorteo, nEntradas,
                            vista.getDiaSorteo(), hora);
                    break;
                case "Sorteo por fechas":
                    res = centroExposicion.confgiurarSorteoFechas(exposicion, fechaSorteo, nEntradas,
                            vista.getFechaInicioSorteo(), vista.getFechaFinSorteo());
                    break;
