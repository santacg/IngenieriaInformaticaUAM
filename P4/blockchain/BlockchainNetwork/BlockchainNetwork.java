...
/**
 * Implementa una red de blockchain con capacidad para añadir, remover y conectar elementos.
 * Permite la gestión de nodos y subredes dentro de la red, facilitando su expansión y mantenimiento.
 * 
...
public class BlockchainNetwork implements IConnectable {
     ...
     * @return La instancia actual de BlockchainNetwork para permitir encadenamiento.
     */
    ...
    /**
     * Devuelve una representación en cadena de la red de blockchain, mostrando todos los elementos conectados.
     * 
