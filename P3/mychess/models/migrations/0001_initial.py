# Generated by Django 4.2.2 on 2024-04-05 08:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(verbose_name=1200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PENDING', 'Pendiente'), ('ACTIVE', 'Activa'), ('FINISHED', 'Finalizada')], default='PENDING', max_length=8)),
                ('board_state', models.TextField(help_text='Almacena la posición de las piezas en formato FEN')),
                ('start_time', models.DateTimeField(auto_now_add=True)),
                ('end_time', models.DateTimeField(blank=True, help_text='Tiempo de finalización de la partida', null=True)),
                ('time_control', models.CharField(help_text='Control de tiempo para cada jugador', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moves', to='models.chessgame')),
